...
const Footer = () => {
    ...
    return (
        <div>
            <footer className="px-4 py-8 md:px-8 bg-[#e7f9fd]/50">
                <div className="max-w-lg sm:mx-auto text-center">
                    <Link to="/" className="text-3xl lg:text-4xl font-semibold flex justify-center">
                        <img src="./logo.png" alt="" className="w-40 lg:w-48" />
                    </Link>
                    <p className="leading-relaxed mt-2 text-[15px] opacity-80">
                        Stay connected for updates, recipes, and special offers. Join our community and savor the best of FoodiePlanet!
                    </p>
                </div>
                ...
                <div className="mt-4 lg:mt-8 items-center lg:flex-row flex-col-reverse justify-between flex gap-4">
                    <div className="mt-4 sm:mt-0">
                        &copy; 2024 FoodiePlanet || All rights reserved.
                    </div>
